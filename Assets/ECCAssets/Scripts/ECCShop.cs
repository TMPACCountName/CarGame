	...
	public class ECCShop : MonoBehaviour 
	{
        ...
        public void OnEnable()
        {
            ...
            if (speedMax == 0 && rotateSpeedMax == 0 && healthMax == 0 && damageMax == 0)
            {
                ...
                {
                    if (speedMax < items[index].itemIcon.GetComponent<Standard>().speed) speedMax = items[index].itemIcon.GetComponent<Standard>().speed;
                    if (rotateSpeedMax < items[index].itemIcon.GetComponent<Standard>().rotateSpeed) rotateSpeedMax = items[index].itemIcon.GetComponent<Standard>().rotateSpeed;
                    if (healthMax < items[index].itemIcon.GetComponent<Standard>().health) healthMax = items[index].itemIcon.GetComponent<Standard>().health;
                    if (damageMax < items[index].itemIcon.GetComponent<Standard>().damage) damageMax = items[index].itemIcon.GetComponent<Standard>().damage;
                }
            }
        ...
        public void ChangeItem( int changeValue )
        {
            ...
            if ( items[currentItem].itemIcon )
            {
                ...
                if ( currentIcon.GetComponent<Standard>())
                {
                    // Fill values for the icons
                    if (transform.Find("Base/Stats/Speed/Full"))    transform.Find("Base/Stats/Speed/Full").GetComponent<Image>().fillAmount = currentIcon.GetComponent<Standard>().speed/speedMax;
                    if (transform.Find("Base/Stats/RotateSpeed/Full")) transform.Find("Base/Stats/RotateSpeed/Full").GetComponent<Image>().fillAmount = currentIcon.GetComponent<Standard>().rotateSpeed/rotateSpeedMax;
                    if (transform.Find("Base/Stats/Health/Full")) transform.Find("Base/Stats/Health/Full").GetComponent<Image>().fillAmount = currentIcon.GetComponent<Standard>().health/healthMax;
                    if (transform.Find("Base/Stats/Damage/Full")) transform.Find("Base/Stats/Damage/Full").GetComponent<Image>().fillAmount = currentIcon.GetComponent<Standard>().damage / damageMax;

                    // Text values inside the icons
                    if (transform.Find("Base/Stats/Speed/Text")) transform.Find("Base/Stats/Speed/Text").GetComponent<Text>().text = currentIcon.GetComponent<Standard>().speed.ToString();
                    if (transform.Find("Base/Stats/RotateSpeed/Text")) transform.Find("Base/Stats/RotateSpeed/Text").GetComponent<Text>().text = currentIcon.GetComponent<Standard>().rotateSpeed.ToString();
                    if (transform.Find("Base/Stats/Health/Text")) transform.Find("Base/Stats/Health/Text").GetComponent<Text>().text = currentIcon.GetComponent<Standard>().health.ToString();
                    if (transform.Find("Base/Stats/Damage/Text")) transform.Find("Base/Stats/Damage/Text").GetComponent<Text>().text = currentIcon.GetComponent<Standard>().damage.ToString();
                }
            }
        ...
        public void SelectItem()
        {
            ...
            if (items[currentItem].lockState == 1)
            {
                ...
                gameController.playerObject = items[currentItem].itemIcon.GetComponent<Standard>();

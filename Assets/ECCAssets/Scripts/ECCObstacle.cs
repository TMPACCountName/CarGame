...
namespace EndlessCarChase
{
    ...
    public class ECCObstacle : MonoBehaviour
    {
        ...
        void OnTriggerStay(Collider other)
        {
            ...
            if (other.GetComponent<Standard>() )
            {
                ...
                //{
                    ...
                    if (other.GetComponent<Standard>().health - damage > 0 && other.GetComponent<Standard>().hitEffect) Instantiate(other.GetComponent<Standard>().hitEffect, transform.position, transform.rotation);
                //}
